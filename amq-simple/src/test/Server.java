...
public class Server {
	...
	public Server(String clientQueueName, long msg_count) {
		...
		try {
			...
			for (int i = 1; i <= msg_count; i++) {
				...
				TextMessage message = session
						.createTextMessage(readFile("./src/test/input2.txt"));
	...
	public static void main(String[] args) {
		...
		new Server(clientQueueName, msg_count);
	}
